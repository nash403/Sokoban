...
/**
 * 
 * the configurations for the entire SokoBlob game. The spriteSize is used
 * everywhere in the game to create the tile-per-tile aspect of the game.
 * 
...
public class SokobanConfiguration extends GameConfiguration {
	...
	public SokobanConfiguration() {
		super(DEFAULT_ROWS_NUMBER, DEFAULT_COLUMNS_NUMBER, DEFAULT_SPRITE_SIZE,
				DEFAULT_LIVES_NUMBER);
	}
